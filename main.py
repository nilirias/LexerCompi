...
def generateOpCuadruple(self, op):
    ...
    self.vardir.add_var(temporal, self.dir)
    print(
        f'generateOpCuadruple entro lo: {lo} - op: {op} - ro: {ro} - temp: {temporal}'
    )
    loDir = self.vardir.get_var_address(lo)
    roDir = self.vardir.get_var_address(ro)
    print(f'generateOpCuadruple address loDir: {loDir} - roDir: {roDir}')
    #print(f'296 {lo}')
...
class MikuParser(Parser):
    ...
    def vd1(self, p):
        print(f'vd1 {p[-1]}')
        self.funcdir.add_func(self.funcid, self.functype, 'varc', self.pcont,
                              'vart', self.vardir)
        self.vardir = VarDir()
        print(self.funcdir)
        print(self.vardir)
    ...
    def var_declaration_func(self, p):
        print(f'var declaration func {p[0]}')
        return p[0]
    ...
    @_('variable', 'CTE_NUM nvarcte', 'CTE_STR svarcte', 'cte_bool bvarcte',
       'func_call')
    def var_cte(self, p):
        print(f'var_cte {p[0]}')
        return p[0]
    ...
    def q4(self, p):
        ...
        while len(self.operadores) > 0:
            ...
            if (op == '>' or op == '<' or op == '<=' or op == '>='
                ...
                # print(f'q4 entro lo: {lo} - ro: {ro} - temp: {self.temporal}')
                # print(f'q4 get_var_address {self.vardir.get_var_address(lo)}')
                # if ((self.vardir.get_var_address(lo) >= 1500
                #      and self.vardir.get_var_address(lo) < 2000)
                #         or (self.vardir.get_var_address(lo) >= 3000
                #             and self.vardir.get_var_address(lo) < 3500)
                #         or (self.vardir.get_var_address(lo) >= 4500
                #             and self.vardir.get_var_address(lo) < 5000)):
                #     self.lotype = 'number'

                # if ((self.vardir.get_var_address(lo) >= 500
                #      and self.vardir.get_var_address(lo) < 999)
                #         or (self.vardir.get_var_address(lo) >= 2000
                #             and self.vardir.get_var_address(lo) < 2500)
                #         or (self.vardir.get_var_address(lo) >= 3500
                #             and self.vardir.get_var_address(lo) < 4000)
                #         or (self.vardir.get_var_address(lo) >= 5000
                #             and self.vardir.get_var_address(lo) < 5500)):
                #     self.lotype = 'word'

                # if ((self.vardir.get_var_address(lo) >= 1000
                #      and self.vardir.get_var_address(lo) < 1500)
                #         or (self.vardir.get_var_address(lo) >= 2500
                #             and self.vardir.get_var_address(lo) < 3000)
                #         or (self.vardir.get_var_address(lo) >= 4000
                #             and self.vardir.get_var_address(lo) < 4500)
                #         or (self.vardir.get_var_address(lo) >= 5500
                #             and self.vardir.get_var_address(lo) < 6000)):
                #     self.lotype = 'bool'

                # if ((self.vardir.get_var_address(ro) >= 1500
                #      and self.vardir.get_var_address(ro) < 2000)
                #         or (self.vardir.get_var_address(ro) >= 3000
                #             and self.vardir.get_var_address(ro) < 3500)
                #         or (self.vardir.get_var_address(ro) >= 4500
                #             and self.vardir.get_var_address(ro) < 5000)):
                #     self.rotype = 'number'

                # if ((self.vardir.get_var_address(ro) >= 500
                #      and self.vardir.get_var_address(ro) < 1000)
                #         or (self.vardir.get_var_address(ro) >= 2000
                #             and self.vardir.get_var_address(ro) < 2500)
                #         or (self.vardir.get_var_address(ro) >= 3500
                #             and self.vardir.get_var_address(ro) < 4000)
                #         or (self.vardir.get_var_address(ro) >= 5000
                #             and self.vardir.get_var_address(ro) < 5500)):
                #     self.rotype = 'word'

                # if ((self.vardir.get_var_address(ro) >= 1000
                #      and self.vardir.get_var_address(ro) < 1500)
                #         or (self.vardir.get_var_address(ro) >= 2500
                #             and self.vardir.get_var_address(ro) < 3000)
                #         or (self.vardir.get_var_address(ro) >= 4000
                #             and self.vardir.get_var_address(ro) < 4500)
                #         or (self.vardir.get_var_address(ro) >= 5500
                #             and self.vardir.get_var_address(ro) < 6000)):
                #     self.rotype = 'bool'
    ...
    def exp(self, p):
        print(f'exp quad {self.quadruples}')
        print(f'exp {p[0]}')
        return p[0]
    ...
    def q2(self, p):
        ...
        while len(self.operadores) > 0:
            ...
            if (op == '*' or op == '/'):
                ...
                # self.temporal = self.temporal + 1
                # self.operandos.append(self.temporal)
                # print(f'q2 entro lo: {lo} - ro: {ro} - temp: {self.temporal}')
                # print(f'q2 get_var_address {self.vardir.get_var_address(lo)}')
                # loDir = self.vardir.get_var_address(lo)
                # roDir = self.vardir.get_var_address(ro)
                # #print(f'296 {lo}')
                # if ((loDir >= 1500 and loDir < 2000)
                #         or (loDir >= 3000 and loDir < 3500)
                #         or (loDir >= 4500 and loDir < 5000)):
                #     self.lotype = 'number'

                # if ((loDir >= 500 and loDir < 999)
                #         or (loDir >= 2000 and loDir < 2500)
                #         or (loDir >= 3500 and loDir < 4000)
                #         or (loDir >= 5000 and loDir < 5500)):
                #     self.lotype = 'word'

                # if ((loDir >= 1000 and loDir < 1500)
                #         or (loDir >= 2500 and loDir < 3000)
                #         or (loDir >= 4000 and loDir < 4500)
                #         or (loDir >= 5500 and loDir < 6000)):
                #     self.lotype = 'bool'

                # if ((roDir >= 1500 and roDir < 2000)
                #         or (roDir >= 3000 and roDir < 3500)
                #         or (roDir >= 4500 and roDir < 5000)):
                #     self.rotype = 'number'

                # if ((roDir >= 500 and roDir < 1000)
                #         or (roDir >= 2000 and roDir < 2500)
                #         or (roDir >= 3500 and roDir < 4000)
                #         or (roDir >= 5000 and roDir < 5500)):
                #     self.rotype = 'word'

                # if ((roDir >= 1000 and roDir < 1500)
                #         or (roDir >= 2500 and roDir < 3000)
                #         or (roDir >= 4000 and roDir < 4500)
                #         or (roDir >= 5500 and roDir < 6000)):
                #     self.rotype = 'bool'
...
#quads mult div
    ...
    def q1(self, p):
        ...
        if (len(self.operadores) > 0):
            ...
            if (op == '+' or op == '-'):
                ...
                # self.temporal = self.temporal + 1
                # self.operandos.append(self.temporal)
                # print(f'q1 entro lo: {lo} - ro: {ro} - temp: {self.temporal}')
                # # print(f'sumas {lo} {ro}')
    ...
    def q3(self, p):
        ...
        if (len(self.operadores) > 0):
            ...
            if (op == '='):
                ...
                print(f'q3 entro lo: {lo} - temp: {temp}')
                myQuad = Quadruple(lo, ro, op,
                                   (self.vardir.get_var_address(temp)))
                self.quadruples.append(myQuad)
                self.quadcount = self.quadcount + 1
            else:
                self.operadores.append(op)
    ...
    def func2(self, p):
        ...
        self.paramQuad = Quadruple(self.operandos.pop(), None, 'PARAM',
                                   self.paramCont)
